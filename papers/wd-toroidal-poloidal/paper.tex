...
The meridional cut shows the star is prolate,
$R_{\mathrm{pol}}/R_{\mathrm{eq}} = 1.102$ with
$R_{\mathrm{eq}} = 5.21\times10^{8}$\,cm, which is the deformation a
toroidal field produces and the opposite of rotation's. $B_\varphi$ is
