...
tight helix. Following the drawn lines until each closes its meridional
circuit gives between $17$ and $20$ turns around the axis per circuit.
This is the twisted-torus geometry with the twist taken to an extreme:
the poloidal circuit is barely traced out before the line has wrapped the
axis a score of times.
...
$|B_\varphi|/|\mathbf{B}_{\mathrm{p}}|$ averages between $35$ and $255$,
varying by nearly an order of magnitude from surface to surface, while
the winding number changes by less than a fifth. The two quantities
...
wireframe. Lines lie on nested flux surfaces and wind $17$ to $20$ times
around the axis for each circuit they complete in the meridional plane.}
\label{fig:lines3d}
\end{figure}
