...
def fig_fieldlines():
    ...
    # Colourbar horizontal, under the three panels: a vertical one at the
    # right puts its tick labels into the neighbouring axis.
    gs = fig.add_gridspec(2, 3, height_ratios=[1, 0.075],
