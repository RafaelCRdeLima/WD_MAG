...
$t = 12$\,s. Both grids now reach $t \simeq 58$\,s, and over that baseline the
two central dynamical claims converge: \textbf{the profile steepens by $22.6\%$
against $20.3\%$}, and \textbf{$L_z$ brakes at half the rate once the field is
gone --- $0.200$ against $0.214\%$\,s$^{-1}$ while it lives, $0.087$ against
$0.094\%$\,s$^{-1}$ after --- so the identification of the transport as
magnetic holds at two resolutions}. What does not converge is the leftover
field: the residual magnetic energy is $25$ times larger at $256^3$ than at
$192^3$, and at $256^3$ it is still slowly growing at $t = 58$\,s.
...
$t = 78$\,s}; everything else in the report is measured to $t = 58.2$\,s. Data:
...
The $256^3$ run reached $t = 58.2$\,s, so the two grids now overlap over almost
...
last two rows are the same comparison made over two baselines: at $14$\,s the
two grids appear to disagree by a factor of eight, at $46$\,s they agree to
$10\%$. Neither number is wrong; the short one simply does not contain the
onset. \emph{A convergence test over a window shorter than the lag between the
...
since a run that is still gaining magnetic energy at $t = 58$\,s has not
...
\item \textbf{A short baseline can invert the sign of a delayed effect.} The
      ...
      measured to $t = 58$\,s they agree to $10\%$. Two earlier drafts of this
...
\item \textbf{The residual field is not converged and is not settled.} At
      ...
      \emph{rising} at $t = 58$\,s. Everything this report says about a
...
$256^3$: analysed here to $t = 58.2$\,s. The run has since been carried to
$t = 78$\,s and the chain continues towards $100$\,s; only
Fig.~\ref{fig:mri} uses the longer baseline, and no other number here has been
recomputed over it.
