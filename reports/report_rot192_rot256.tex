...
\subsection{Past $12$\,s: the steepening, on two grids}
...
\paragraph{The differential rotation not only survives, it strengthens.} The
numbers below are $192^3$; Sec.~\ref{sec:latewindow} shows the $256^3$ run does
the same thing, delayed and then faster, so the direction is a result and the
