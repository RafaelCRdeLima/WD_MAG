...
$L_z^{\mathrm{outer}}/L_z^{\mathrm{inner}}$$^{\dagger}$ & $6.35$ & $4.35$ & $\mathbf{-32\%}$ \\
\midrule
...
the star as a whole loses $5.5\%$ and the inner half gains. \emph{The star survives because the field never came close to
...
$1.5$\,s pulsation. \textbf{(c)} the differential rotation itself; uniform
rotation would be $1$ and the star moves away from it. \textbf{(d)} $L_z$ of
