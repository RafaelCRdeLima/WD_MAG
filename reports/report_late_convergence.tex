...
$192^3$: complete, $t = 60$\,s, field diagnostics now processed over the whole
run. \quad $256^3$: analysed here to $t = 58.2$\,s, all $164$ plotfiles
processed; the run has since reached $t = 78$\,s and the chain continues
towards $100$\,s. Nothing in this report has been recomputed over the longer
baseline.
...
here is \texttt{investigations/bt\_bp\_256\_long.csv}, read to $t = 58.2$\,s
(the file has since grown to $210$ rows and $t = 78$\,s),
