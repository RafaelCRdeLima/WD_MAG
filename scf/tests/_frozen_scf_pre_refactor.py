"""COPIA CONGELADA do scf/scf.py de ANTES da refatoracao para termos
plugaveis (rotacao + toroidal autoconsistente) — commit 1b02e01/20e8807.
Existe SO' para o teste de regressao V-R0 (test_regression_v0.py) ter uma
referencia externa, independente, de bit a bit. NAO IMPORTAR em nenhum
outro lugar; NAO ATUALIZAR conforme scf.py evolui — o ponto e' justamente
continuar sendo o comportamento antigo, congelado.
